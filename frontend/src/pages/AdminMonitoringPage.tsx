...
import { 
  FaCalendarAlt, FaFileDownload, FaMoneyBillWave, 
  FaMobileAlt, FaUserFriends, FaBullseye, FaCircle 
} from 'react-icons/fa';
...
const AdminMonitoringPage: React.FC = () => {
  ...
  return (
// ... (lanjut ke kode return di bawahnya)
      ...
      <main className="admin-main">
        ...
        <div className="monitoring-container">
          ...
          <div className="kpi-grid">
            <div className="kpi-card">
              <div className="kpi-top">
                <div className="kpi-icon bg-purple-light text-purple"><FaMoneyBillWave /></div>
              </div>
            ...
            <div className="kpi-card">
              <div className="kpi-top">
                <div className="kpi-icon bg-pink-light text-pink"><FaMobileAlt /></div>
              </div>
            ...
            <div className="kpi-card">
              <div className="kpi-top">
                <div className="kpi-icon bg-orange-light text-orange"><FaUserFriends /></div>
              </div>
            ...
            <div className="kpi-card">
              <div className="kpi-top">
                <div className="kpi-icon bg-blue-light text-blue"><FaBullseye /></div>
              </div>
              <p className="kpi-label">Tingkat Konversi</p>
              <h2 className="kpi-value">3.4%</h2>
            </div>
          </div>
          ...
          <div className="chart-row-2">
            ...
            {/* Distribusi Pendapatan (Donut Chart CSS) */}
            <div className="widget-card flex-1">
              ...
              <div className="chart-legend">
                <div className="legend-item">
                  <span><FaCircle className="text-purple" /> Hotel</span>
                  <span className="fw-bold">52%</span>
                </div>
                <div className="legend-item">
                  <span><FaCircle className="text-blue" /> Transport</span>
                  <span className="fw-bold">34%</span>
                </div>
                <div className="legend-item">
                  <span><FaCircle className="text-yellow" /> Destinasi</span>
              ...
              <div className="ranking-list">
                <div className="ranking-item">
                  ...
                  <div className="rank-info">
                    <h4>Alila Villas Uluwatu</h4><p>Bali, Indonesia</p>
                  </div>
                ...
                <div className="ranking-item">
                  ...
                  <div className="rank-info">
                    <h4>Amanjiwo Borobudur</h4><p>Magelang, Indonesia</p>
                  </div>
                  <div className="rank-stats">
                    <h4>Rp 650jt</h4>
                  </div>
                ...
                <div className="ranking-item">
                  ...
                  <div className="rank-info">
                    <h4>The Ritz-Carlton Mega</h4><p>Jakarta, Indonesia</p>
                  </div>
                  <div className="rank-stats">
                    <h4>Rp 520jt</h4>
                  </div>
            ...
            <div className="widget-card">
              ...
              <div className="crowd-stats-list">
                <div className="crowd-item">
                  <div className="crowd-header"><span>Bali (Ocean Front)</span><span className="text-purple fw-bold">85%</span></div>
                  <div className="progress-bg"><div className="progress-fill bg-purple" style={{width: '85%'}}></div></div>
                </div>
                <div className="crowd-item">
                  <div className="crowd-header"><span>Yogyakarta (Borobudur)</span><span className="text-yellow fw-bold">62%</span></div>
                  <div className="progress-bg"><div className="progress-fill bg-yellow" style={{width: '62%'}}></div></div>
                </div>
                <div className="crowd-item">
                  <div className="crowd-header"><span>Lombok (Mandalika)</span><span className="text-blue-light fw-bold">45%</span></div>
                  <div className="progress-bg"><div className="progress-fill bg-blue-light" style={{width: '45%'}}></div></div>
                </div>
              </div>
            </div>
          ...
          <div className="widget-card">
            <div className="map-header">
              ...
              <div className="map-legend">
                <span><FaCircle className="text-purple" /> {'>'} 1,000 Booking</span>
                <span><FaCircle className="text-purple-light" /> {'<'} 500 Booking</span>
              </div>
            </div>
            ...
            <div className="map-container">
              ...
              <div className="regional-analysis-box">
                ...
                <div className="ra-stats">
                  <div><h2>64%</h2><p>JAWA & BALI</p></div>
                  <div><h2>22%</h2><p>SUMATERA</p></div>
                  <div><h2>14%</h2><p>LAINNYA</p></div>
                </div>
              </div>
            </div>
          </div>
